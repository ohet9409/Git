	...
	<table border="1">
		...
		<tr>
			<td colspan="6" align="center">
				...
				<c:if test="${pg==i}">
					[<a href="/19-imageboard/imageboard/imageboardList.jsp?pg=${i}" id="currentPaging"> ${i}]</a></c:if><!-- 절대경로 -->
					<c:if test="${pg!=i}">
					[<a href="/19-imageboard/imageboard/imageboardList.jsp?pg=${i}" id="paging"> ${i}]</a></c:if><!-- 절대경로 -->
				</c:forEach>
