...
<form action="boardWritePro.do" style="width: 480px; "method="post" name="boarForm" enctype="multipart/form-data">
	<table>
		<tr>
			<td id="a">글쓴이</td>
		...
		<tr>
			<td id="a">파일첨부</td>
			<td bgcolor="skyblue"><input type="file" required="required"> </td>
		</tr>
		<tr>
