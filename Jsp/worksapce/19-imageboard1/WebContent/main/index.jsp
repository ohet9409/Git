...
<body>
	...
	<div id="container">
		<div id="nav">
		<p>\${memId}: ${memId}님</p>
			<h3><a href="/19-imageboard/main/index.jsp">메인 화면</a></h3>
			<a href="/19-imageboard/main/index.jsp?req=boardList&pg=1">글목록</a><br>
		...
		<c:if test="${memId != null}"> <!-- // 로그인 상태 -->
			...
			<a href="/19-imageboard/main/index.jsp?req=imageboardWriteForm">이미지등록</a><br>
			<a href="/19-imageboard/imageboard/imageboardList.jsp?pg=1">이미지 목록</a><br>
		</div>
		<div id="section">
